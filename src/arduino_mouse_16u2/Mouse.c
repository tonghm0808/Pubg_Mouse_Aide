 ...
 * either REPORT_ITEM_TYPE_In or REPORT_ITEM_TYPE_Feature \param[out]
 ...
 * the received report from the host \param[in] ReportData  Pointer to a buffer
 * where the created report has been stored \param[in] ReportSize  Size in
 * bytes of the received HID report
 */
